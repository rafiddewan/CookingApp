...
export default class Recipe{
    ...
    parseIngredients () {
        ...
        const unitsLong = ['tablespoon', 'tablespoons', 'tbsps', 'ounces', 'ounce', 'teaspoons', 'teaspoon', 'tsps', 'cups', 'pounds'];
        const unitShort = ['tbsp', 'tbsp', 'tbsp', 'oz', 'oz', 'tsp', 'tsp', 'tsp', 'cup', 'pound'];
